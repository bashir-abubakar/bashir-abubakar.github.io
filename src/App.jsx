...
export default function App() {
  return (
            <div
              className="min-h-screen w-full pt-32 px-6 pb-10 
          ...
          >
            ...
            <p className="text-blue-100 text-lg">
              ...
              resilience and social justice, and to ensuring that emerging technologies benefit
              communities fairly and sustainably.
              <br /><br />
