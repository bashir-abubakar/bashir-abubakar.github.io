...
export default function About() {
  return (
    <>
      {/* ------------------------------------------------------------- */}
      {/* SEO — React Helmet for About Page                             */}
      {/* ------------------------------------------------------------- */}
      <Helmet>
        <title>About — Bashir Abubakar</title>

        <meta
          name="description"
          content="Learn more about Bashir Abubakar, an NHS Mental Health Data Analyst specialising in AI, NLP, predictive modelling, sustainability and healthcare innovation."
        />

        <meta
          name="keywords"
          content="About Bashir Abubakar, NHS, Mental Health Analyst, AI Specialist, NLP, Predictive Modelling, Healthcare Data Science, Youth Leadership"
        />

        {/* OpenGraph */}
        <meta property="og:title" content="About — Bashir Abubakar" />
        <meta
          property="og:description"
          content="Discover the story, background and impact of Bashir Abubakar — NHS Mental Health Data Analyst applying AI and responsible innovation to health systems."
        />
        <meta property="og:url" content="https://bashir-abubakar.github.io/about" />
        <meta property="og:image" content="https://bashir-abubakar.github.io/og-image.png" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About — Bashir Abubakar" />
        <meta
          name="twitter:description"
          content="Learn about Bashir's professional journey and work in AI, mental health and healthcare innovation."
        />
